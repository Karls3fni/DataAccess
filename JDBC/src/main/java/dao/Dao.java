...
public class Dao {
    ...
    public void mostrarEmpleadosInverso(Connection connection) {
        ...
        try (connection) {
            ...
            System.out.println("Hemos obtenido la conexión a la base de datos para mostrar empleados en orden inverso.");
            ...
            // Mostramos al revés
            System.out.println("Empleados (del último al primero):");
    ...
    public void contarFilasConsulta(Connection connection, String sql) {
        try (connection) {
            if (connection == null) {
                throw new Exception("Error al obtener la conexión a la base de datos.");
            }
            ...
            try (Statement stmt = connection.createStatement(
                ...
                rs.last();  // mover al final
                int numeroFilas = rs.getRow();  // obtener número total
